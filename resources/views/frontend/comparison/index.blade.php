                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <select id="keyword1" ng-model="mycar1" class=" form-control make">
                                                <!--<option ng-repeat="car in data" ng-value="car.id_car_make">d</option>-->
                                               
                                                
                                                @foreach( $makemode as $car)
<option value="{{$car['id_car_make'].','.$car['id_car_model'].','.$car['id_car_trim']}}" ng-value="{{$car['id_car_make'].','.$car['id_car_model'].','.$car['id_car_trim']}}">{{$car['name']}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xs-4 col-sm-4">
                                        <div class="form-group">
                                            <select id="keyword2" ng-model="mycar2" name="keyword2" class="form-control make">
                                                <!--<option ng-repeat="car in makemodel" ng-value="car.car_id">@{{car.car_name}}</option>-->
                                               
                                                @foreach( $makemode as $car)
                                                    <option ng-value="{{$car['id_car_make'].','.$car['id_car_model'].','.$car['id_car_trim']}}" value="{{$car['id_car_make'].','.$car['id_car_model'].','.$car['id_car_trim']}}">{{$car['name'].$car['car_models.name']}}</option>
                                                     @endforeach
                                            </select>
                                            </select>
                                            <input type="hidden" ng-model="formData._token" id="token" value="{{csrf_token()}}">
                                        </div>

                                    </div>
                                    <div class="col-md-8 col-md-offset-4 col-xs-offset-4 col-sm-offset-4  col-xs-8  col-sm-8" >
 <button type="button" class="btn btn-block btn-theme" ng-click="compare(mycar1,mycar2)"> Comapre</button>
                                    </div>
                                </div>
