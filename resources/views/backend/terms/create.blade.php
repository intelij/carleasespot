...
@section('content')
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="control-label" style="padding:20px;">Terms</label>
  ...
  <div class="card-body pad">
              <div class="mb-3">
                <textarea class="textarea" placeholder="Place some text here" name="terms" value="<?php if(!empty($terms)){
echo $terms->terms;} else { echo old('terms'); } ?>"style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php if(!empty($terms)){
echo $terms->terms;} else { echo old('terms'); } ?>
                          </textarea>
              </div> </div>
