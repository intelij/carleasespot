...
@section('scripts')
    ...
    <!-- JQVMap -->
    <script src="{{asset('assets/backend/vendor/jqvmap/dist/jquery.vmap.js')}}"></script>
    <script src="{{asset('assets/backend/vendor/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
    <script src="{{asset('assets/backend/vendor/jqvmap/examples/js/jquery.vmap.sampledata.js')}}"></script>
